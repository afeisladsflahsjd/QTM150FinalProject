...
-   from here we concluded that 60% farmland or greater was adequate in an ideal location, reducing our sample to 40% of the counties in the US
...
-   While we might have been able to be stricter in our range, we simply want to get a broad list of candidate counties, and \<100 humans per square mile removed most outliers
...
-   Of our candidates, we take out counties without a gun manufacturer as counties without one would most likely have less ammunitions to defend against the zombies
...
-   Our drought severity parameter ranged between 0 to 3, as average to slightly wet would most likely yield the most crops
...
-   Average temperature ranged from 55 to 71, contains most candidate counties.
-   This feels reasonable as well, as it isn't too cold nor too warm, which may cause quality of life issues
...
-   Temperature ranges were roughly 75 degrees throughout the year, contains most candidate counties.
...
-   Percent farmland below 0.1, or 10%, contains most candidate counties.
