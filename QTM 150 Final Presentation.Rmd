...
# Maps of Important Statistics 1

-   Here are a few examples of variable maps for our variables. For the sake of brevity, we only include drought severity and precipitation here. Afterwards, we'll show the zombei index map, which takes into consideration all the variables.

```{r, fig.width=7, fig.height=5, dev="png"}
...
# Maps of Important Statistics 2

-   This is a continuation of the previous slide. We can see trends in rainfall here.
